...
par(mfrow=c(1,2))
hist(dados$act_baseline, 
     main="Histograma: ACT baseline", 
     xlab="Score ACT", 
     ylab="Frequência", 
     col="lightblue")

qqnorm(dados$act_baseline, 
       main="Q-Q Plot: ACT baseline",
       xlab="Quantis Teóricos",
       ylab="Quantis da Amostra")
qqline(dados$act_baseline, col="red")
...
par(mfrow=c(1,2))
hist(dados$act_semana12, 
     main="Histograma: ACT semana 12", 
     xlab="Score ACT", 
     ylab="Frequência", 
     col="lightblue")

qqnorm(dados$act_baseline, 
       main="Q-Q Plot: ACT semana 12",
       xlab="Quantis Teóricos",
       ylab="Quantis da Amostra")
qqline(dados$act_baseline, col="red")
...
par(mfrow=c(1,2))   
hist(dados$exacerbacoes_12sem, 
     main="Histograma: Exacerbações", 
     xlab="Nº de Exacerbações", 
     ylab="Frequência", 
     col="lightblue")

qqnorm(dados$exacerbacoes_12sem, 
       main="Q-Q Plot: Exacerbações",
       xlab="Quantis Teóricos",
       ylab="Quantis da Amostra")
qqline(dados$exacerbacoes_12sem, col="red")
...
par(mfrow=c(1,2))
hist(dados$adesao, 
     main="Histograma: Adesão", 
     xlab="Adesão (%)", 
     ylab="Frequência", 
     col="lightblue")

qqnorm(dados$adesao, 
       main="Q-Q Plot: Adesão",
       xlab="Quantis Teóricos",
       ylab="Quantis da Amostra")
qqline(dados$adesao, col="red")
...
par(mfrow=c(1,2))
hist(dados$peak_flow_baseline, 
     main="Histograma: Peak Flow Inicial", 
     xlab="Peak Flow (L/min)", 
     ylab="Frequência", 
     col="lightblue")

qqnorm(dados$peak_flow_baseline, 
       main="Q-Q Plot: Peak Flow Inicial",
       xlab="Quantis Teóricos",
       ylab="Quantis da Amostra")
qqline(dados$peak_flow_baseline, col="red")
...
par(mfrow=c(1,2))
hist(dados$peak_flow_semana12, 
     main="Histograma: Peak Flow Final", 
     xlab="Peak Flow (L/min)", 
     ylab="Frequência", 
     col="lightblue")

qqnorm(dados$peak_flow_semana12, 
       main="Q-Q Plot: Peak Flow Final",
       xlab="Quantis Teóricos",
       ylab="Quantis da Amostra")
qqline(dados$peak_flow_semana12, col="red")
